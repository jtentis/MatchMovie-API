...
@Module({
  imports: [PrismaModule, AuthModule, MoviesModule, GroupsModule, FavoritesModule, WatchedModule, MatchModule, IngressoModule, HttpModule, GeolocationModule, ConfigModule.forRoot({ isGlobal: true })],
